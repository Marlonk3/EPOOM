/**
 * Panel que permite mostrar un mensaje de aviso antes de empexar la busqueda en al sección de bsucar por carnet
 * 
...
public class PanelDefaultBusc extends JPanel{
   private JLabel nota;
   ...
   public PanelDefaultBusc(){
      ...
      ImageIcon imagenBuscar= new ImageIcon(PanelDefaultBusc.class.getResource("/Img/buscar.png"));
