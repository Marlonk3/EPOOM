...
import gui.PnlCrearInforme;

public class CrearInformeMedicoListener implements ActionListener {
	private PnlCrearInforme frame;
	private int clicks = 1;
	private int indiceFinal, indiceComienzo, infPaginado;

	public CrearInformeMedicoListener(PnlCrearInforme frame) {
		this.frame = frame;
...
//				frame.refrescarInformacionPaginas();
	...
	public PnlCrearInforme getFrame() {
		return frame;
	}

	public void setFrame(PnlCrearInforme frame) {
		this.frame = frame;
	}
